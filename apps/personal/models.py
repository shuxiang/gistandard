...
class WorkOrder(models.Model):
    ...
    status_choices = (('0', '退回'), ('1', '新建-保存'), ('2', '提交-等待审批'), ('3', '已审批-等待执行'), ('4', '已执行-等待确认'), ('5', '完成'))
    ...
    file_content = models.FileField(upload_to='file_folder/%Y/%m', blank=True, null=True, verbose_name='项目资料')
