# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-12-11 08:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birday', models.DateField(blank=True, null=True, verbose_name='出生日期')),
        ...
        migrations.AddField(
            model_name='userprofile',
            name='roles',
            field=models.ManyToManyField(blank=True, related_name='roles', to='rbac.Role', verbose_name='角色'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='superior',
